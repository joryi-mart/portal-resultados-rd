...
export async function generarImagenResultados(loteriaNombre, resultados) {
  const alturaFila = 92;
  ...
  const svg = `
    <svg width="1080" height="${alto}" viewBox="0 0 1080 ${alto}" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="80" y="264" font-family="Arial, Helvetica, sans-serif" font-size="28" fill="#9AB0CC">Resultados de hoy</text>
