...
function ResumenResultados(props: { items: UltimoResultado[]; fecha: string }) {
  ...
  const ORDEN_IMPORTANCIA = ["nacional", "leidsa", "loteka", "la-suerte", "la-primera", "real", "lotedom", "anguila", "new-york", "haiti"];
  ...
  return (
    <div className="overflow-hidden rounded-2xl bg-[#10203A]">
      ...
      {tarjetas.length === 0 ? (
        ...
        <div className="mx-3 mb-3 columns-1 gap-3 sm:mx-4 sm:mb-4 sm:columns-2 lg:columns-3">
