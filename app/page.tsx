...
function ResumenResultados(props: { items: UltimoResultado[]; fecha: string }) {
  ...
  const ORDEN_IMPORTANCIA = ["nacional", "leidsa", "real", "loteka", "la-suerte", "la-primera", "lotedom", "new-york", "anguila"];
  ...
  return (
    <div className="overflow-hidden rounded-2xl bg-[#10203A]">
      ...
      {tarjetas.length === 0 ? (
        ...
        <div className="mx-3 mb-3 grid grid-cols-1 items-start gap-3 sm:mx-4 sm:mb-4 sm:grid-cols-2 lg:grid-cols-3">
