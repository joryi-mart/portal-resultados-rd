...
export default function FarandulaCliente() {
  ...
  return (
    <div className="min-h-screen bg-[#FBF7EE]">
      ...
      <div className="px-4 py-8 sm:px-8">
        <h1 className="mb-2 text-2xl font-bold text-[#10203A]">🎤 Farándula y Dembow</h1>
        <p className="mb-6 rounded-lg bg-[#1E4D8C]/5 p-3 text-xs text-[#5C6B78]">
          Lo último de la farándula dominicana: artistas, dembow, música urbana y entretenimiento.
        </p>
